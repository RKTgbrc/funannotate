...
DBURL = {
    ...
    "dbCAN": "http://dbcan-hcc.unl.edu/download/Databases/V11/dbCAN-HMMdb-V11.txt",
    "dbCAN-tsv": "http://dbcan-hcc.unl.edu/download/Databases/V11/CAZyDB.08062022.fam-activities.txt",
...
busco_links = {
    ...
    "pezizomycotina": (
        "https://osf.io/bj3sm/download?version=1",
        "pezizomycotina_odb9",
    ),
    "eurotiomycetes": (
        "https://osf.io/nvt3z/download?version=1",
        "eurotiomycetes_odb9",
    ),
    "sordariomycetes": (
        "https://osf.io/r24kn/download?version=1",
        "sordariomyceta_odb9",
    ),
    "saccharomycetes": (
        "https://osf.io/mpu2k/download?version=1",
        "saccharomyceta_odb9",
    ),
    "saccharomycetales": (
        "https://osf.io/dhk47/download?version=1",
    ...
    "alveolata_stramenophiles": (
        "https://osf.io/waqpe/download?version=1",
    ...
    "actinopterygii": (
        "https://osf.io/dj2cw/download?version=1",
        "actinopterygii_odb9",
    ),
    ...
    "euarchontoglires": (
        "https://osf.io/p3nc7/download?version=1",
        "euarchontoglires_odb9",
    ),
    "laurasiatheria": (
        "https://osf.io/2v9hj/download?version=1",
        "laurasiatheria_odb9",
    ),
